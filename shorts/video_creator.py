...
## 나레이션 규칙 (매우 중요!)
- **한 문장은 반드시 15자 이내!** 길면 무조건 끊어라. 줄글 절대 금지.
- 나레이션 전체 길이: 100~120자 이내. 짧을수록 좋다.
- 예시 리듬: "안녕하십니까. 3조입니다. / 오늘 주제는요. / 21세기 인류의 초콜릿 광기입니다. / 이 사람들이요. / 초콜릿 하나를 사려고. / 4시간을 줄 섰습니다. / 네. 4시간이요. / 근데 진짜 문제는요. / 그걸 되팔았습니다. / 3배 가격에요. / 교수님 이건 저도 이해가 안 됩니다. / 다음 발표에서 더 기막힌 거 가져오겠습니다."
- 이처럼 **짧게 끊어서 템포감 있게**. 말이 빨리빨리 넘어가야 함.
- 쉼표(,)보다 마침표(.)로 끊어서 TTS가 확실히 끊어 읽게 할 것
- 발표 중 본인 감정 표현으로 웃김 추가 ("이건 저도 좀요.", "솔직히 웃겼습니다.")
...
{{
    ...
    "narration": "전체 나레이션 (100~120자. 한 문장 15자 이내. 마침표로 끊어서 템포감 있게)",
    "scenes": [
        {{
            "text": "화면에 표시할 텍스트",
            "duration": 3.0,
