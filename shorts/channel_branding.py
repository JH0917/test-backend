...
## 채널 컨셉
밸런스게임 질문에 나름의 논리와 유머로 결론을 내주는 채널.
캐치프레이즈: "결론 내드립니다"
마무리 멘트: "여러분 선택은?"

## 만들어야 할 것
1. 채널명: 짧고 임팩트 있게 (2~4단어). "결론"이나 "밸런스" 관련 키워드 포함하면 좋음. 한눈에 밸런스게임 채널인 걸 알 수 있게.
2. 채널 설명: 한 줄로. "매일 밸런스게임 결론 내드립니다" 같은 느낌.
3. 배너 이미지 프롬프트: DALL-E용 영어 프롬프트. VS 대결 느낌의 역동적인 일러스트. 왼쪽/오른쪽 대비되는 구도. 텍스트 없이. 밝고 임팩트 있는 색감.
4. 프로필 이미지 프롬프트: DALL-E용 영어 프롬프트. 저울이나 VS 심볼을 모티브로 한 심플한 아이콘/마스코트. 단색 배경. 작은 원형에서도 잘 보이게. 텍스트 없이.
