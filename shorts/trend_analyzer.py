...
HIGH_HEAT_QUESTIONS = [
    ...
    # === 연애 (댓글 폭발 1위 카테고리) ===
    "외모 완벽한데 냄새 지옥인 애인 vs 외모 별로인데 향기 천국인 애인",
    "연락 하루 1번 근데 만나면 다정 vs 연락 100번 근데 만나면 무관심",
    "나만 좋아하는 사람 (나는 별로) vs 나도 좋아하는 사람 (근데 바람둥이)",
    "애인이 전 애인 꿈꾸는 거 들킴 vs 내가 전 애인 꿈꾸는 거 들킴",
    "바람 피고 평생 숨기는 애인 vs 자백하고 용서 구하는 애인",
    "1년에 한 번 만나는 완벽한 연인 vs 매일 만나는 지루한 연인",
    "애인이 내 핸드폰 매일 확인 vs 애인이 자기 핸드폰을 절대 안 보여줌",
    ...
    "연봉 1억인데 매일 야근 자정 vs 연봉 3천인데 매일 칼퇴 4시",
    "상사가 천사인데 일이 지옥 vs 일은 꿈의 직장인데 상사가 악마",
    "하루 1억 벌지만 모든 말끝에 '냥' 붙이기 vs 평범하게 살기",
    "10억 받고 SNS 평생 금지 vs 돈 없이 SNS 자유",
    # === 극한/판타지 (공유율 최고) ===
    "바퀴벌레 1마리와 1년 동거하고 10억 vs 돈 없이 바퀴벌레 없는 집",
    "3일 동안 내 과거가 모두에게 공개 vs 3일 동안 내 생각이 주변 5명에게 들림",
    "10년 젊어지는 대신 기억 10년 지워짐 vs 10년 늙는 대신 미래 10년 기억 생김",
    "평생 같은 음식만 먹되 맛있는 거 vs 매일 새 음식이지만 항상 그저 그럼",
    "평생 민트초코만 먹기 vs 평생 치킨을 소스 없이 먹기",
    "내 인생 전체가 유튜브 라이브 vs 내 생각이 자막으로 뜸",
]
